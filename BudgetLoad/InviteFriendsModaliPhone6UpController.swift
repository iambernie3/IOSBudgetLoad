//
//  InviteFriendsModaliPhone6UpController.swift
//  BudgetLoad
//
...
class InviteFriendsModaliPhone6UpController: UIViewController,MFMessageComposeViewControllerDelegate {
    ...
    func sendToContact(sender: UITapGestureRecognizer){
        ...
        //messageVC.recipients = ["09332574017"]
        messageVC.body = msg;
...
//        self.presentViewController(controller, animated: true, completion: { _ in })
    ...
    func sendToWhatsApp(sender: UITapGestureRecognizer){
        ...
        print("whatsapp")
        if let whatsappURL: NSURL = NSURL(string: "whatsapp://"){
